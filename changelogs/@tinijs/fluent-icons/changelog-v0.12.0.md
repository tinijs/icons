...
## Added
- `icon-calendar-note-filled`
- `icon-calendar-note-regular`
- `icon-checkmark-underline-circle-filled`
- `icon-checkmark-underline-circle-regular`
- `icon-data-bar-vertical-ascending-regular`
- `icon-data-bar-vertical-ascending-filled`
- `icon-globe-arrow-up-filled`
- `icon-globe-arrow-up-regular`
- `icon-globe-error-filled`
- `icon-globe-error-regular`
- `icon-globe-prohibited-filled`
- `icon-globe-prohibited-regular`
- `icon-globe-sync-regular`
- `icon-globe-sync-filled`
- `icon-globe-warning-filled`
- `icon-globe-warning-regular`
- `icon-organization-horizontal-filled`
- `icon-organization-horizontal-regular`
- `icon-person-square-checkmark-filled`
- `icon-person-square-checkmark-regular`
- `icon-phone-footer-arrow-down-filled`
- `icon-phone-footer-arrow-down-regular`
- `icon-phone-header-arrow-up-regular`
- `icon-phone-header-arrow-up-filled`
